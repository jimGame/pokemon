...
module EffectUtils {
    ...
    //obj         闪烁对象
    //interval    闪烁总工时间
    export function blinkEffect(obj,interval:number = 1000,callBack?:Function,thisObj?: any,params?: Array<any>):void{
        new BitmapBlink(obj,interval,true,callBack,thisObj,params); 
    }
    ...
    //抖动对象特效
    // 1：抖动  2：震动
    var isPlayShake:Boolean = false; 
    export function shakeScreen(obj,effectType:number = 1,callBack?:Function,thisObj?: any,params?: Array<any>):void{
        if(this.isPlayShake){
            return;
        }
        ...
        var callFuncs:Function=function(){
            this.isPlayShake = false;
            if(typeof callBack === "function"){
                if(!params){
                    callBack.call(thisObj);
                }else{
                    if(Utility.isArray(params)){
                        if(params.length == 1){
                            callBack.call(thisObj,params[0]);
                        }else if(params.length == 2){
                            callBack.call(thisObj,params[0],params[1]);
                        }else{
        ...
        if(effectType == 1){
            ...
            egret.setTimeout(function () {              
                egret.Tween.get(panel).to({x:oldX},shakeNum).call(callFuncs,this);
            }, this, shakeNum*5);      
        }else{
            ...
            egret.setTimeout(function () {              
                egret.Tween.get(panel).to({x:oldX,y:oldY},shakeNum).call(callFuncs,this);
            }, this, shakeNum*6);      
        }
    }
    ...
    */
    export function playEffect(obj,cartoonType:number = 1,callBack?:Function,thisObj?: any,params?: Array<any>):void{
    ...
    * interval      打字间隔 毫秒
    */    
    export function typerEffect(obj,content:string = "",interval:number = 200,callBack?:Function,thisObj?: any,params?: Array<any>):void{
        var onComplete2:Function = function(){
            if(typeof callBack === "function"){
                if(!params){
                    callBack.call(thisObj);
